...
(* DONT_TOUCH= "TRUE" *) reg  [(C_S_AXIS_TDATA_WIDTH/4)-1:0] stream_data_fifo [0 : NUMBER_OF_INPUT_WORDS-1];
	// FIFO Implementation
	generate 
	...
	// Add user logic here
    assign fifodata = {stream_data_fifo[0],stream_data_fifo[1],stream_data_fifo[2],stream_data_fifo[3]};
